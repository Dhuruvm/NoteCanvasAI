    ...
    <>
      <style>{`
        ...
        .ghost-image {
          ...
          animation: ghostGlow 4s ease-in-out infinite alternate;
        }
        ...
        @keyframes ghostGlow {
          ...
          100% {
            filter: drop-shadow(0 12px 30px rgba(168, 85, 247, 0.5));
          }
        }
